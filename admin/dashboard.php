		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<!-- <img src="../assets/img/images.png" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white">SMPN 2 Campalagian</b>
				</a>
...
<!-- end modal pengaturan akun -->
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SMP Negeri 2 Campalagian (<a href="index.php">Nurul Ardaniyah</a> | 2025)
					</div>				
				</div>
			</footer>
		</div>
	...
	<body class="hold-transition login-page" style="background:url(images/veloz.jpg)
