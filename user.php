        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/images.jfif" alt="navbar brand" class="navbar-brand" width="40">
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMP Negeri 2 Campalagian</h2>
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y');?> Absensi Siswa SMK NU 03 BONDOWOSO (<a href="index.php">Imas Andriyani </a>
                | 2021)
            </div>
        </div>
    </footer>
