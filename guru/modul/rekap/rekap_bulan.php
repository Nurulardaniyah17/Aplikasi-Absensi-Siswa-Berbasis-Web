...
$bulan = !empty($rowBulan['tgl_absen']) ? date('m', strtotime($rowBulan['tgl_absen'])) : date('m');
 	...
 	<tr>
 		<td>
 			<center>
 				...
 				<h1>
 					ABSENSI SISWA <br>
 					<small> SMKP NEGERI 2 CAMPALAGIAN</small>
 				</h1>
 				<hr>
 				<em>
				 Jl.poros Majene Desa Baru, Kecamatan Luyo,<br> Kabupaten Kabupaten Polewali Mandar, Provinsi Sulawesi Barat, Kode Pos 91353 <br>
...
<table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
  <tr>
    ...
    <td colspan="<?= $tglTerakhir; ?>" style="padding: 8px;">
    PERTEMUAN BULAN : 
    	<b style="text-transform: uppercase;">
        	<?php echo namaBulan($bulan); ?> 
        	<?= !empty($tglBulan) ? date('Y', strtotime($tglBulan)) : date('Y'); ?>
    	</b>
	</td>
